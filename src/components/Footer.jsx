        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-8 flex gap-4">
              <a
                href="#"
                className="flex h-12 w-12 items-center justify-center rounded-full bg-zinc-900 transition hover:bg-yellow-500 hover:text-black"
              >
                <FaFacebookF />
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-12 w-12 items-center justify-center rounded-full bg-zinc-900 transition hover:bg-[#25D366]"
              >
                <FaWhatsapp />
              </a>
