      ...
      <div className="absolute inset-0 flex items-center justify-center px-6">
        <div className="max-w-4xl text-center text-white">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-lg leading-9 text-gray-200 md:text-2xl">
            Take a glimpse into our elegant spa spaces,
            ellness treatments, private rooms, and relaxing
            atmosphere designed for complete peace of mind.
          </p>
